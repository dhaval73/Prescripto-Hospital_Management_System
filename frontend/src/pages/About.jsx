...
const About = () => {
  return (
    ...
    <p>
        <span className='text-xl text-gray-700 font-semibold'>Welcome to Prescripto</span>, Your Trusted Partner in Managing Your Healthcare Needs Conveniently and Efficiently. 
    ...
    <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
        <b>EFFICIENCY:</b>
        <p>Quick and easy appointment booking to fit your busy schedule.</p>
    </div>
    <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
        <b>CONVENIENCE:</b>
        <p>Connect with trusted healthcare professionals near you, effortlessly.</p>
    </div>
    <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
        <b>PERSONALIZATION:</b>
        <p>Get custom health reminders and recommendations tailored to you.</p>
    </div>
</div>
